#
#  Be sure to run `pod spec lint myDynamicFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.vendored_frameworks = "DynamicFramework"
 ...
 # spec.source_files  = "DynamicFramework/**"
